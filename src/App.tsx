    ...
    >
      ...
      <div className="flex flex-col gap-5 items-center justify-center pb-7">
        <picture>
          ...
          <img src={QuoteIconMobile} alt="" aria-hidden />
        </picture>

        <button
          aria-label="Generate a new advice"
          className="bg-primary-Neon-Green p-3.5 rounded-full w-12 h-12 flex items-center justify-center absolute -bottom-5 md:-bottom-6 hover:shadow-neon transition duration-300 cursor-pointer md:p-2 md:w-13 md:h-13"
          onClick={handleClick}
        >
